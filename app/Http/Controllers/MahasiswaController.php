...
class MahasiswaController extends Controller
{
    ...
    {   
        ...
        return view('mahasiswas.index', [
            'mahasiswas' => User::latest('id')->where('userType',1)->paginate(3)
        ]);
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $input['userType'] = 1; // type user mahasiswa
        // dd($input);
    ...
    public function update(Request $request, $id): RedirectResponse
    {
        ...
        return redirect()->route('mahasiswas.index')->withSuccess('Mahasiswa is updated successfully.');
    }
